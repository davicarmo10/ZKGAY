        ...
        while(contador  == 0){
            ...
            if(log.equals("unifap") && senha.equals("unifap123")) {
                ...
                case 1:
                    ...
                    switch(opc) {
                    case 1:
                        JOptionPane.showMessageDialog(null,"Deseja inserir unidades ou caixas(12.und)");
                        JOptionPane.showMessageDialog(null,"1 - Unidades\n2 - Caixa(12.und)");
                        op = in.nextInt();

                        switch(op) {
                            case 1:
                                JOptionPane.showMessageDialog(null,"insira o valor deasejado:");
                                int a = in.nextInt();
                    ...
                    case 3:
                        JOptionPane.showMessageDialog(null,"insira o valor deasejado de resmas:");
                        int val3 = in.nextInt();
                        estoqueAtual.papal = estoqueAtual.papal+val3;
                        break;
                        
                    case 4:
                        JOptionPane.showMessageDialog(null,"Deseja inserir unidades ou caixas(6.und)");
                        JOptionPane.showMessageDialog(null,"1 - Unidades\n2 - Caixa(6.und)");
                        int op2 = in.nextInt();
                        switch(op2) {
                            case 1:
                ...
                case 2:
                    ...
                    switch(opc) {
                    case 1:
                        JOptionPane.showMessageDialog(null,"Deseja retirar unidades ou caixas(12.und)");
                        JOptionPane.showMessageDialog(null,"1 - Unidades\n2 - Caixa(12.und)");
                        op = in.nextInt();
                    ...
                    case 4:
                        JOptionPane.showMessageDialog(null,"Deseja retirar unidades ou caixas(6.und)");
                        JOptionPane.showMessageDialog(null,"1 - Unidades\n2 - Caixa(6.und)");
                        int op2 = in.nextInt();
                        switch(op2) {
                            case 1:
